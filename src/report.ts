...
import { formatNumber, formatTokens, formatCost, formatDuration, pct } from './utils.js';
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><span class="channel-badge">${s.channel}</span></td>
...
<footer>
  <p>Generated by <strong>openclaw-insight</strong> v1.0.0 · Data is 100% local · No data uploaded</p>
</footer>
...
.channel-badge { background: var(--accent)15; color: var(--accent); padding: 0.15rem 0.5rem; border-radius: 4px; font-size: 0.8rem; font-weight: 600; }
